  ...
  return (
    <div>
      ...
      <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-xl border border-slate-200 dark:border-white/[0.06] bg-slate-50 dark:bg-white/[0.02] p-5">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-white/[0.06] bg-slate-50 dark:bg-white/[0.02] p-6">
            ...
            <div className="space-y-4">
              {Object.entries(data.applicationStats).map(([status, count]) => (
                <div key={status}>
                  ...
                  <div className="h-1.5 w-full rounded-full bg-slate-100 dark:bg-white/[0.05]">
                    <div
        ...
        <div className="rounded-xl border border-slate-200 dark:border-white/[0.06] bg-slate-50 dark:bg-white/[0.02] p-6">
          ...
          {data.recentEvents.length === 0 ? (
            <p className="text-sm text-slate-400 dark:text-slate-600">No activity yet</p>
          ) : (
            <div className="space-y-3">
              {data.recentEvents.map((event) => (
                ...
                >
                  <span className="text-sm text-slate-500 dark:text-slate-400">{event.type}</span>
