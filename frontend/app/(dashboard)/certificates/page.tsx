    ...
    <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-white/[0.05] px-3 py-2 text-sm text-slate-700 dark:text-slate-300 outline-none transition file:mr-3 file:rounded-md file:border-0 file:bg-indigo-500 file:px-3 file:py-1.5 file:text-xs file:font-medium file:text-white hover:file:bg-indigo-400"
              />
              {file && (
      ...
      {certificates.length === 0 && !adding ? (
        <div className="flex min-h-[300px] flex-col items-center justify-center rounded-xl border border-dashed border-slate-200 dark:border-white/10">
          ...
          />
          <p className="text-sm text-slate-400 dark:text-slate-600">No certificates yet</p>
          <button
            onClick={() => setAdding(true)}
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {certificates.map((cert) => (
            <div
              key={cert.id}
              className="group rounded-xl border border-slate-200 dark:border-white/[0.06] bg-slate-50 dark:bg-white/[0.02] p-5 transition hover:border-white/[0.1]"
            >
              ...
              <h3 className="mb-1 font-medium text-slate-900 dark:text-white">{cert.title}</h3>
