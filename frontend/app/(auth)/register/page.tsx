...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-white dark:bg-[#0a0a0f] px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        {registered ? (
          <div className="rounded-2xl border border-slate-200 dark:border-white/[0.08] bg-slate-50 dark:bg-white/[0.02] p-8 text-center">
          ...
          <div className="rounded-2xl border border-slate-200 dark:border-white/[0.08] bg-slate-50 dark:bg-white/[0.02] p-8">
            {/* GitHub button */}
            <button
              onClick={handleGitHubLogin}
              className="mb-6 flex w-full items-center justify-center gap-3 rounded-lg border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-white/[0.04] py-2.5 text-sm font-medium text-slate-900 dark:text-white transition hover:bg-white/[0.08]"
            >
              ...
              <div>
                ...
                <div className="flex items-center rounded-lg border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-white/[0.05] px-4 py-2.5 transition focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent text-sm text-slate-900 dark:text-white placeholder-slate-600 outline-none"
                  />
                </div>
                {errors.username && (
                  <p className="mt-1 text-xs text-red-400">
              ...
              <div>
                <div className="flex items-start gap-3">
                  <input
                    ...
                    id="agreed"
                    {...register("agreed")}
                    className="mt-0.5 rounded border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-white/[0.05]"
                  />
                  <label
                    htmlFor="agreed"
                  ...
                  >
                    ...
                    <a
                      href="/terms"
                      target="_blank"
                      className="text-slate-700 dark:text-slate-300 underline transition hover:text-slate-900 dark:hover:text-white"
                    >
                      Terms of Service
                    </a>{" "}
                    and{" "}
